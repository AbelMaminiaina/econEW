  ...
  const cards: { type: AccountType; title: string; text: string; icon: React.ReactNode }[] = [
    {
      type: 'particulier',
      title: 'Particulier',
      text: 'Achetez en gros volume (quantité minimum par produit), au prix catalogue. Compte actif immédiatement, paiement à la livraison ou au retrait.',
      icon: <User className="h-7 w-7 text-prairie-600" />,
    },
    {
      type: 'professionnel',
      title: 'Professionnel',
      text: 'Tarifs dégressifs par quantité et facturation à 30/60 jours en plus. Compte entreprise validé par notre équipe.',
