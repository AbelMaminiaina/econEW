...
export const metadata: Metadata = {
  ...
  description:
    'Découvrez notre catalogue multi-catégories pour professionnels : emballage, fournitures de bureau, hygiène, quincaillerie, électronique, textile. Tarifs dégressifs, livraison à Antananarivo.',
  keywords: [
