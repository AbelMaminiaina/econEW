...
const filieres = [
  {
    slug: 'porc',
    title: 'Porc',
    text: 'Porc sur pied, carcasses et découpes, vendus au kilo à partir de 90 kg.',
    image: '/images/services/filiere-porc.jpeg',
    alt: 'Porcs de notre élevage',
  },
  {
    slug: 'volaille',
    title: 'Volaille',
    text: 'Poulets, canards et cailles vendus à la pièce, par lots de 500 minimum.',
    image: '/images/services/filiere-volaille.jpeg',
    alt: 'Volaille de notre élevage',
  },
];
    ...
    <div className="min-h-screen bg-cream-50">
      ...
      <section className="relative h-[40vh] min-h-[300px] flex items-center">
        <div className="absolute inset-0">
          <Image
            src="/images/services/hero-tech.jpg"
        ...
        >
          <div className="text-center mb-8">
            <h2 className="text-3xl font-display font-bold text-warm-800 mb-4">
              Nos filières viande et volaille
            </h2>
            <p className="text-warm-600 max-w-2xl mx-auto">
              Du porc à partir de 90&nbsp;kg et de la volaille par lots de 500 pièces,
              pour la restauration, la charcuterie et les revendeurs.
            </p>
          </div>
